...
**Type:** [e.g. own business, client, partner, investment]
**Status:** [e.g. active, paused, winding down, pre-launch]
**Stage:** [e.g. idea, MVP, revenue-generating, scaling]
...
### Open Items
- [anything pending or in progress]
