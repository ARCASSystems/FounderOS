...
Wiki-layer scope is defined by `scripts/_common.py:WIKI_LAYER_PREFIXES` and
`WIKI_LAYER_EXCLUDED_PARTS`. Update those constants - not this file - to
change scope.
...
from _common import normalize_wikilink_target, wiki_layer_files  # noqa: E402
...
def extract_links(text: str):
    ...
    _common.normalize_wikilink_target() so [[file]] and [[file.md]] produce
    the same node."""
    in_fence = False
...
def main():
    ...
    for md in wiki_layer_files(repo):
