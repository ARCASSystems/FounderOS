...
description: >
  Structured founder coaching and diagnostic system. Use this skill when the user wants to "check in on" a founder, "prep a coaching session", "do a founder review", "map someone's roles", "time audit", "energy check", "identity mapping", "founder diagnostic", "capacity review", "how is [person] doing", "wartime or peacetime", "is this founder in warzone", or any reference to coaching, mentoring, or diagnosing a founder's state, capacity, role overload, or operational zone. Also trigger when the user describes a founder (including themselves) who is stuck, stretched, burning out, overwhelmed, avoiding hard work, confusing busy with productive, or trapped in too many roles - even if they don't use the word "coaching". This skill covers check-in prep, session capture, founder state diagnosis, bias challenging, and role mapping. Works for self-coaching (the founder using this to examine their own state) and for coaching clients.
mcp_requirements: []
---
