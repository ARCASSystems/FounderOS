...
4. **Wait for a yes per diff.** Apply only what was approved. Then stamp `last_review: <today>` on the row and re-run `python scripts/employee_verdict.py render`.
