...
Pulls the latest System Layer files from the public repo (ARCASSystems/FounderOS) and applies them to this install. The User Layer (identity, context, cadence, brain, network, clients) stays untouched.
...
- CLAUDE.md, README.md, stack.json, VERSION

Your User Layer files will NOT be touched:
- core/identity.md
- context/, cadence/, brain/, network/, clients/
...
1. `git stash push -m "founder-os-update-backup-<ISO-timestamp>" -- .claude .claude-plugin skills templates notion-package CLAUDE.md README.md stack.json VERSION`
